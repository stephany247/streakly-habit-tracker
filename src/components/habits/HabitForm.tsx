...
export default function HabitForm({ habit, onSave, onCancel }: HabitFormProps) {
  ...
  return (
    ...
    >
      <h3 className="text-white font-bold text-lg">{habit ? 'Edit Habit' : 'New Habit'}</h3>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="habit-name" className="block text-sm font-medium text-zinc-200 mb-1.5">
        ...
        <div>
          <label htmlFor="habit-description" className="block text-sm font-medium text-zinc-200 mb-1.5">
            Description
          </label>
          <input
        ...
        <div>
          <label htmlFor="habit-frequency" className="block text-sm font-medium text-zinc-200 mb-1.5">
            Frequency
          </label>
          <select
            id="habit-frequency"
